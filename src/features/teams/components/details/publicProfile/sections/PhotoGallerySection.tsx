        ...
        <div className="space-y-4 mt-4">
            ...
            {value.items.map((item: any, i: number) => (
                <div
                    ...
                    className={`group rounded-2xl border bg-white/80 backdrop-blur shadow-sm p-5 space-y-4 transition 
    ${dragIndex === i ? "opacity-50 ring-2 ring-purple-400" : "hover:shadow-md"}`}
                    ...
                    <div className="flex flex-col md:flex-row gap-5">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[90px] rounded-xl border border-gray-200 bg-white/70 px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:outline-none"
                                onChange={(e) => {
                                    const items = [...value.items];
            ...
            {!disabled && (
                <button
                    ...
                    className="mt-4 px-4 py-2 rounded-lg bg-purple-600 text-white text-sm"
                >
                    + Add Photo
                </button>
            )}
